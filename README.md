...
一个强大的微信公众号文章生成与推送技能,支持通过AI生成符合公众号规范的 HTML 文章,并推送到公众号草稿箱或直接发布。

## ✨ 功能特性 
 
- 🔒 **安全配置** - 通过在线向导快速配置,无需泄露公众号密钥，无需配置公众号白名单
- 📝 **图文生成** - 按照 design.md 规范自动生成符合公众号格式的 HTML 文章
- 🚀 **一键推送** - 推送文章到公众号草稿箱，推送成功后有服务通知
...
- 📊 数据报告转换成图文
- 🗓️ 定期内容推送自动化
- 🔗 **兼容其它 Skill 生成的 HTML**：复制到本目录后，直接执行推送命令即可发布到公众号
